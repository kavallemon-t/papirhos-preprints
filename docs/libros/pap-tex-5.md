...
<img src="../../assets/covers/pap-tex-5.png" alt="Portada de Geometría euclidiana bidimensional y su grupo de transformaciones">
</div>
<div class="libro-hero-contenido">
<p class="libro-eyebrow">Ficha bibliográfica</p>
<h1 class="libro-titulo">Geometría euclidiana bidimensional y su grupo de transformaciones</h1>
...
<div class="edition-selector" id="edition-selector-pap-tex-5">
    ...
    <div class="edition-content">
        <div id="edicion-pap-tex-5-0" class="edition-panel"><h3 class="edition-panel-title">Edición sin especificar</h3><section class="libro-subseccion libro-metadatos"><h3>Metadatos</h3>
<table>
    <tbody>
