...
<img src="../../assets/covers/pap-tex-7.png" alt="Portada de Clases características">
</div>
<div class="libro-hero-contenido">
<p class="libro-eyebrow">Ficha bibliográfica</p>
<h1 class="libro-titulo">Clases características</h1>
...
<div class="edition-selector" id="edition-selector-pap-tex-7">
    ...
    <div class="edition-content">
        <div id="edicion-pap-tex-7-0" class="edition-panel"><h3 class="edition-panel-title">Edición sin especificar</h3><section class="libro-subseccion libro-metadatos"><h3>Metadatos</h3>
<table>
    <tbody>
        <tr><th>Autores</th><td>John Milnor, James Stasheff</td></tr><tr><th>Colección</th><td>Papirhos</td></tr><tr><th>Serie</th><td>Textos</td></tr><tr><th>Editorial</th><td>Instituto de Matemáticas, UNAM</td></tr><tr><th>ISBN (Colección)</th><td>000</td></tr>
    </tbody>
</table>
</section><section class="libro-subseccion libro-cita"><h3>Cómo citar</h3><div class="citation-box"><blockquote id="cita-ed-012">John Milnor, James Stasheff. <em>Clases características</em>. Instituto de Matemáticas, UNAM.</blockquote><button type="button" class="citation-copy-button" data-target="cita-ed-012">Copiar cita</button></div><details><summary>BibTeX</summary><textarea id="bibtex-ed-012" rows="9" cols="80" class="verbatim">@BOOK{ed-012,
title = {Clases características},
author = {Milnor, John and Stasheff, James},
publisher = {Instituto de Matemáticas, UNAM},
address = {México}
}</textarea><br><button type="button" class="bibtex-copy-button" data-target="bibtex-ed-012">Copiar BibTeX</button></details></section></div>
    </div>
</div>
...
<a class="md-button  data-book-id=pap-tex-7 download-link" data-book-id="pap-tex-7" href ="pap-tex-7_mark.pdf" download> Descargar</a>
<details>
<summary> Ver en línea (vista previa)</summary>
<object data = "pap-tex-7_mark.pdf" type="application/pdf" width="100%" height="700" >
<p> Tu navegador no puede mostrar PDF incrustado <a href="pap-tex-7_mark.pdf" target="_blank" rel ="noopener"> Abrir PDF </a> o usa el botón "Descargar".</p>
</object>
</details>
</div>
</section>
