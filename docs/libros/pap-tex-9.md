...
<img src="../../assets/covers/pap-tex-9.png" alt="Portada de Introducción al álgebra lineal">
</div>
<div class="libro-hero-contenido">
<p class="libro-eyebrow">Ficha bibliográfica</p>
<h1 class="libro-titulo">Introducción al álgebra lineal</h1>
...
<div class="edition-selector" id="edition-selector-pap-tex-9">
    ...
    <div class="edition-content">
        <div id="edicion-pap-tex-9-0" class="edition-panel"><h3 class="edition-panel-title">Edición sin especificar</h3><section class="libro-subseccion libro-metadatos"><h3>Metadatos</h3>
<table>
    <tbody>
