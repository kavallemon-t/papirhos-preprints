...
<img src="../../assets/covers/pap-tex-12.png" alt="Portada de Métodos topológicos en el estudio de las ecuaciones diferenciales no lineales">
</div>
<div class="libro-hero-contenido">
<p class="libro-eyebrow">Ficha bibliográfica</p>
<h1 class="libro-titulo">Métodos topológicos en el estudio de las ecuaciones diferenciales no lineales</h1>
...
<div class="edition-selector" id="edition-selector-pap-tex-12">
    ...
    <div class="edition-content">
        <div id="edicion-pap-tex-12-0" class="edition-panel"><h3 class="edition-panel-title">Edición sin especificar</h3><section class="libro-subseccion libro-metadatos"><h3>Metadatos</h3>
<table>
    <tbody>
